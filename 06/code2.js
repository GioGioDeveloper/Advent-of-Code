 ...
 */
function count_loop_lock(mappa, direzione = 0, posx = 0, posy = 0){
  if(direzione < 0 || direzione > 3) return 0; 
...
// });
let loop_lock = 0;
//ho un loop lock ogni qual volta cambio direzione 3 volte e
//- mi ritrovo a passare per la posizione x, y dove x è uguale alla x presente al 3° cambio di posizione e y alla y del 1° cambio di posizione
loop_lock = count_loop_lock(matrice, 0, pos_guardia[0], pos_guardia[1]);
console.log(loop_lock);